...
folder are mapped to the application's root namespace, 'tstaro2'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'tstaro2' in the same way
as `"tstaro2/sass/src"`.
